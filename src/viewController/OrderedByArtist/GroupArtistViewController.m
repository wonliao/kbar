...
#import "GroupArtistViewController.h"

@interface GroupArtistViewController ()
@property (nonatomic, strong) NSArray *sampleItems;
@end

@implementation GroupArtistViewController
@synthesize sampleItems;

- (void)awakeFromNib
{
    self.sampleItems = [NSArray arrayWithObjects: @"草蜢",nil];
