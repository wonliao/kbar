...
#import "AllArtistViewController.h"

@interface AllArtistViewController ()
@property (nonatomic, strong) NSArray *sampleItems;
@end

@implementation AllArtistViewController
@synthesize sampleItems;

- (void)awakeFromNib
{
    self.sampleItems = [NSArray arrayWithObjects: @"蔡依林",@"周杰倫",
                        @"劉德華", @"梅豔芳", @"鄧麗君",@"伍佰",@"張惠妹",@"梁靜茹",
                        @"張學友",@"李聖傑",@"草蜢",nil];
}
