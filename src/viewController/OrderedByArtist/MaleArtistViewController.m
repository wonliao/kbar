...
#import "MaleArtistViewController.h"

@interface MaleArtistViewController ()
@property (nonatomic, strong) NSArray *sampleItems;
@end

@implementation MaleArtistViewController
@synthesize sampleItems;

- (void)awakeFromNib
{
    self.sampleItems = [NSArray arrayWithObjects: @"周杰倫",
                        @"劉德華",@"伍佰",@"張學友",@"李聖傑",@"草蜢",nil];
