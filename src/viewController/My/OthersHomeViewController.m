...
#import "OthersHomeViewController.h"

@interface OthersHomeViewController ()
@property (nonatomic, retain) NSMutableArray *dataArray;
@end

@implementation OthersHomeViewController
