...
@synthesize gradientStartColor = _gradientStartColor,
            ...
            gradientStartPoint = _gradientStartPoint,
            gradientEndPoint = _gradientEndPoint;
...
/*
- (void)setGradientStartPoint:(CGPoint)startPoint AndEndPoint:(CGPoint)endPoint
{
    self.gradientStartPoint = CGPointMake( startPoint.x, startPoint.y );
    self.gradientEndPoint = CGPointMake( endPoint.x, endPoint.y );
}
*/
#pragma mark -
#pragma mark Drawing
